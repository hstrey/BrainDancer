...
#  				 niread(joinpath(DATA_DIR, "mask.nii"));
# phantom = niread(joinpath(DATA_DIR, "epi", "epi_corrected.nii"));
phantom = niread("static_bfc.nii");

# ╔═╡ 1bf97d88-32a4-4e93-9d9c-9ac95de16a7c
size(phantom)
...
let images = []
	for i in 1:size(phantom,3)
		pp = plot(Gray.(genimg(phantom[:,:,i,1])),aspect_ratio=1.0,axis = nothing,framestyle=:none,title="$i")	
		push!(images,pp)
	end
...
# ╔═╡ b08687ea-1f31-4085-9b72-5838b3810dd6
function getellipse(img::AbstractMatrix)
	segs = segment3(img)
	fitellipse3(img, segs, edge3(segs))
end

# ╔═╡ d1308e8a-c995-40d1-92b5-095cbd27b70b
[getellipse(phantom[:,:,i,1]) for i in 1:12]
...
julia_version = "1.8.1"
manifest_format = "2.0"
project_hash = "96e2e9a437b359d4de1b778b574c318a1769e01f"
